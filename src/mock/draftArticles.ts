...
export const draftPostSeeds: DraftPostSeed[] = [
  {
    ...
    spec: articleSpec(
      ...
      ],
      {
        ...
        "constitution-trading": section("trading-and-future-obligations", "Article VI - Trading and future obligations", ["constitution-trading-cards"]),
        ...
        "constitution-drafts": section("drafts", "Article VII - Drafts", ["constitution-draft-cards"]),
        "constitution-draft-cards": cards([
          ...
          { title: "Missed selections", body: "When a clock expires, Sleeper auto-pick or the published queue rule applies. A technical outage affecting reasonable access pauses the draft for all teams." },
        ]),
